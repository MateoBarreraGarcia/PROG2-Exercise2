...
class HomeControllerTest {
    ...
    static void init() {
        ...
        TestMovieData.add(new Movie("Test Film 1", "This is a Test Film", new ArrayList<Genre>() {{
            add(Genre.ACTION);
            add(Genre.ANIMATION);
        }}, "123456", 2000, ".\\Image\\TestImage1", 115, new ArrayList<>() {{
            add("Director 1-1");
            add("Director 1-2");
        }}, new ArrayList<>() {{
            add("Writer 1-1");
        ...
        TestMovieData.add(new Movie("Test Film 2", "This is a Test Film", new ArrayList<Genre>() {{
            add(Genre.COMEDY);
            add(Genre.CRIME);
        }}, "374849345", 1937, ".\\Image\\TestImage2", 60, new ArrayList<>() {{
            add("Director 2-1");
            add("Director 2-2");
        }}, new ArrayList<>() {{
            add("Writer 2-1");
        ...
        TestMovieData.add(new Movie("Test Film 3", "This is a Test Film", new ArrayList<Genre>() {{
            add(Genre.FANTASY);
            add(Genre.BIOGRAPHY);
        }}, "703234", 2024, ".\\Image\\TestImage3", 70, new ArrayList<>() {{
            add("Director 3-1");
            add("Director 3-2");
        }}, new ArrayList<>() {{
            add("Writer 1-1");
        ...
        TestMovieData.add(new Movie("Test Film 4", "This is a Test Film", new ArrayList<Genre>() {{
            add(Genre.ACTION);
            add(Genre.ROMANCE);
        }}, "4920453", 2003, ".\\Image\\TestImage4", 320, new ArrayList<>() {{
            add("Director 1-1");
            add("Director 4-2");
        }}, new ArrayList<>() {{
            add("Writer 4-1");
        ...
        TestMovieData.add(new Movie("Test Film 5", "This is a Test Film", new ArrayList<Genre>() {{
            add(Genre.HISTORY);
            add(Genre.MUSICAL);
        }}, "938045", 1980, ".\\Image\\TestImage5", 160, new ArrayList<>() {{
            add("Director 5-1");
            add("Director 5-2");
        }}, new ArrayList<>() {{
            add("Writer 5-1");
        ...
        TestMovieData.add(new Movie("Test Film 6", "This is a Test Film", new ArrayList<Genre>() {{
            add(Genre.DOCUMENTARY);
            add(Genre.MYSTERY);
        }}, "293052", 1906, ".\\Image\\TestImage6", 78, new ArrayList<>() {{
            add("Director 6-1");
            add("Director 2-2");
        }}, new ArrayList<>() {{
            add("Writer 6-1");
        ...
        TestMovieData.add(new Movie("Test Film 7", "This is a Test Film", new ArrayList<Genre>() {{
            add(Genre.FAMILY);
            add(Genre.DOCUMENTARY);
        }}, "9302354", 1998, ".\\Image\\TestImage7", 49, new ArrayList<>() {{
            add("Director 4-2");
            add("Director 7-2");
        }}, new ArrayList<>() {{
            add("Writer 2-1");
    ...
    void get_between_years_returns_all_movies_released_between_start_year_and_end_year() {
        ...
        // when
        List<Movie> actual = homeController.getMoviesBetweenYears(movies, 2000, 2020);
